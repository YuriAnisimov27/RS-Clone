...
export const AuthPage = () => {
  ...
  function PointJS(Ua, Va, yb, Sc) {
    ...
    var k = window, A = this, K = !1, Da = 'fixed', Vb = 0, Wb = 0, zb = 100, Xb = function (a) {
      a = a.getBoundingClientRect();
      return {y: a.top + k.pageYOffset, x: a.left + k.pageXOffset};
    }, Ec = function (a) {
    ...
    var Ea = !0, Ab = !0, Zb = !0, ja = !1, Fa = !0, m = Ua, n = Va, na = Ua, oa = Va,
      H = m / 2, I = n / 2, pa = 1, qa = 1, g = {x: 0, y: 0},
      t = {fillStyle: 'black', strokeStyle: 'black', globalAlpha: 1, font: 'serif', textBaseline: 'top'},
      ea = function (a) {
    ...
    this.vector.moveCollision = function (a, b, c, f, d, e) {
      ...
      var n = 2 + h.x;
      for (m = 2 + h.y; 0 <= k; k--) if (h = b[k], h.visible && a !== h && !(d && !h.isInCameraStatic() || e && a.getDistanceC(h.getPositionC()) >
    ...
    this.vector.moveCollisionAngle = function (a, b, c, f, d, g, h) {
      ...
      c = 0;
      d = b.length;
      for (var E; c < d; c += 1) if (E = b[c], !g || E.isInCamera()) if (!h || !a.getDistanceC(E.getPositionC())) {
    ...
    var cc = 0, l = {
      ...
      addEvent: function (a, b, c) {
        'onload' === a && l.loaded ? c() : l.events[a].push({id: b, func: c});
      },
    ...
    if ('object' === typeof yb) for (var Eb in yb) Eb.match(/margin|padding|position/) ||
    (q.style[Eb] = yb[Eb]);
    ...
    this.system.setStyle = function (a) {
      if ('object' === typeof a) for (var b in a) q.style[b] = a[b];
    };
    ...
    var aa = {}, Ka = {}, ta = {}, La = !1, Ma = !1, $a = !1, ab = !1, Kc = function (a) {
      G(ta, function (a, c, f) {
        1 == a && (f[c] = 2);
      });
    };
    ...
    e(0, 0);
    var Oa = !0, cb = '', db = !1, ua = e(0, 0), eb = !1, Hb = {LEFT: 1, RIGHT: 3, MIDDLE: 2},
      Ib = {1: 'LEFT', 3: 'RIGHT', 2: 'MIDDLE'}, fb = !1, gb = {}, hb = {}, Pa = {}, Aa = 0, hc = function () {
        gb = {};
        hb = {};
        Pa = {};
        Aa = 0;
    ...
    var ob = function (a, b, c, f) {
      ...
      var c = parseInt(a.substr(0, 2), 16), f = parseInt(a.substr(2, 2), 16), d = parseInt(a.substr(4, 2), 16);
      return ob(c, f, d, b);
    };
    ...
    var w = function (a) {
      ...
      var f, d;
      for (f in a) if ((!c || a.hasOwnProperty(f)) && 'undefined' !== typeof a[f] && (d = b(a[f], f, a)) && 'break' === d) break;
    }, v = function (a, b) {
      if (a.length) for (var c = a.length - 1, f; 0 <= c && ("undefined" === typeof a[c] || !(f = b(a[c], c, a) || !1) || "break" !== f); c--) ;
    };
    ...
    var mc = function (a) {
      ...
      var c = !1, f = Bb(), d = !1, e = new XMLHttpRequest, g = function () {
        e.open('GET', a, !0);
        e.send();
      };
    ...
    this.OOP.forXY = function (a, b, c) {
      var f, d, e;
      for (d = 0; d < b; d += 1) for (f = 0; f < a && (!(e = c(f, d)) || "break" != e); f += 1) ;
    };
    this.OOP.forArr = v;
    ...
    this.OOP.delObject = function (a, b) {
      var c;
      var f = 0;
      for (c = a.length; f < c; f += 1) if (a[f] == b) return a.splice(f, 1), !0;
    };
    ...
    F.prototype = {
      ...
      dataSet: function (a, b) {
        ...
        b; c += 1) if (this.children[c].id == a.id) {
        ...
        var b = 0, c = !1, f;
        var d = 0;
        for (f = a.length; d < f; d += 1) if (this.id !== a[d].id) {
        ...
        for (c = b.length - 1; 0 <= c; c--) if (ra(b[c], a)) return !0;
        for (c = b.length - 1; 0 <= c; c--) if (ra(a[c], b)) return !0;
        return !1;
        ...
        if (3 > a.length) return !1;
        var b = this.getDynamicBox(), c, f = 0;
        var d = 0;
    ...
    Ob.prototype.draw = function () {
      if (this.loaded) {
        ...
        for (f = 0; f < this.countY; f += 1) if (!(this.y + f * this.h + this.h < g.y || this.y + f * this.h > g.y + n)) for (c = 0; c <
    ...
    this.brush.drawImageS = function (a) {
      ...
      } else p[a.file] = {loaded: !1}, b = k.document.createElement('img'), b.onload = function () {
        p[a.file].loaded = !0;
        p[a.file].img = this;
    ...
    xb.setCSSTransform = function (a, b) {
      var c = (b ? b.canvas : q).style, d = 'perspective(' + m + 'px)';
      G(a, function (a, b) {
        d += ' ' + b + '(' + a + ')';
      });
    ...
    d.keyMoveInit = function (a,
      ...
      if (c) a(c) && (d.key.keyMoveDX = d.key.SPEED || 1); else if (a('D') || a('RIGHT')) d.key.keyMoveDX = d.key.SPEED || 1;
      if (e) a(e) && (d.key.keyMoveDX = -d.key.SPEED || -1); else if (a('A') || a('LEFT')) d.key.keyMoveDX = -d.key.SPEED || -1;
      if (g) a(g) && (d.key.keyMoveDY = -d.key.SPEED || -1); else if (a('W') || a('UP')) d.key.keyMoveDY = -d.key.SPEED || -1;
    ...
    this.memory.local = {
      storage: k.localStorage, clear: function () {
        this.storage.clear();
      }, save: function (a, b) {
