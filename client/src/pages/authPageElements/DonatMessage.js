...
export const DonatMessage = ({active, setActive}) => {
  return (
    ...
    <a className='btn-floating btn-large waves-effect waves-light green donatlink' href='https://opencollective.com/rsschool#section-contribute'><i class="material-icons dimg">$</i></a>
  </div>
